...
class CilingFan extends Fan
{
    ...
    CilingFan(String typeCi, String colorCi, double priceCi,String companyName, String warranty)
    {
        super(companyName, warranty);
        this.typeCi = typeCi;
 ...
 class HierarchicalInheritance
 {
    ...
    {
        TableFan obj = new TableFan("Orient", "2", 1200.0, "Table Fan", "White");
        obj.displayFan();
        obj.displayTableFan();
        CilingFan obj1 = new CilingFan("USHA", "1",1000.0, "Ceiling Fan", "Black" );
